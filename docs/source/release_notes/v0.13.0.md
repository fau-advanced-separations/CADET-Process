...
- `CADETProcess.instruments.knauer` — loader for Knauer FPLC CSV/rfp export files; exposes UV (4 channels), conductivity, pressure, and solvent channels as `ReferenceIO` objects
