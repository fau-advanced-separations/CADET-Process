...
class Variator:
    ...
    def add_error(self, name: str, parameter_path: str, distribution: DistributionBase) -> None:
        """
...
class VariatedVariable:
    ...
    def __init__(self, parameter_path: str, distribution: DistributionBase) -> None:
        """
        ...
        if not isinstance(distribution, DistributionBase):
            raise TypeError(
                "Expected distribution to be an instance of "
                f"DistributionBase, got {type(distribution).__name__}."
            )
    ...
    def __repr__(self) -> str:
        ...
        return (
            f"VariatedVariable(parameter_path='{self.parameter_path}', "
