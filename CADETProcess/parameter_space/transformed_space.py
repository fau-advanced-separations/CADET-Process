...
class TransformedSpace:
    ...
    def lower_bounds(self) -> np.ndarray:
        ...
        globally comparable.
        """
        return self._space.normalize(self._space.lower_bounds)
    ...
    def upper_bounds(self) -> np.ndarray:
        ...
        globally comparable.
        """
        return self._space.normalize(self._space.upper_bounds)
    ...
    def _assemble_matrices(
        ...
        lb_phys = self._space.lower_bounds
        ub_phys = self._space.upper_bounds
