...
CADET-Process is a Python package for modelling, simulating, evaluating and optimizing advanced chromatographic processes. It serves as an inteface for CADET, but can also be used for other solvers.
...
Note
----
This software is work in progress and being actively developed. Breaking changes and extensive restructuring may occur in any commit and release.
